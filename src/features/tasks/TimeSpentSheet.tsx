...
function priorityColor(priority?: string): string {
  if (priority === 'high' || priority === 'P1') return '#ef4444';
  if (priority === 'medium' || priority === 'P2') return '#f59e0b';
  return '#818cf8';
}
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          <motion.div
            className="task-modal-card time-spent-modal"
          ...
          >
            ...
            <div className="time-spent-header">
              <div className="time-spent-header-left">
                <div className="time-spent-icon-badge">
            ...
            <div className="time-spent-list-container">
              ...
              {dateTasks.length === 0 && (
                <div className="time-spent-empty">
                  <Timer size={36} color="rgba(148, 163, 184, 0.4)" />
