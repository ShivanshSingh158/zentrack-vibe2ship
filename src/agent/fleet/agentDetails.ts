...
export const AGENT_DETAILS: Record<string, AgentDetail> = {
  ...
  MERCURY: {
    ...
    tagline: 'Live web search, news & link summarization',
    color: '#94a3b8',
    secondaryColor: '#475569',
    description: 'Scours the web in real-time to track prices, summarize links, read news, and research entities.',
    image: '/agents/search.png',
    icon: '🌐',
    depicts: ['Google Search', 'Link Extraction', 'Price Tracking'],
  },
  GAINS: {
    title: 'Fitness AI Coach',
    tagline: 'Gym tracking, progressive overload & volume analysis',
    color: '#f97316',
    secondaryColor: '#c2410c',
    description: 'A dedicated fitness intelligence unit that analyzes your real-time gym logs and ensures progressive overload.',
    image: '/agents/gains.png',
    icon: '🏋️',
    depicts: ['Progressive Overload', 'Workout Logging', 'Injury Prevention'],
  },
  ORACLE: {
