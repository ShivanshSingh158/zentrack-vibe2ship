...
| [`src/services/geofenceService.ts`](file:///c:/Users/perso/.gemini/antigravity/scratch/zentrack-vibe2ship/mobile/src/services/geofenceService.ts) | `calculateDistanceMeters`, `triggerGymArrival`, `ensureLocationServicesEnabled`, `checkImmediateGymProximity`, `getGeofenceDiagnosticStatus`, `syncAllActiveGeofences`, `initGeofencingOnBoot` | Functions | Autonomous background & instant foreground geofence engine: handles headless `ZENTRACK_GEOFENCE_TASK`, 0ms edge-transition bypass via direct Haversine distance, 1-tap Android Google Play Services location enabler, cold-boot auto-arming, and gym arrival/departure state machines. |
...
| [`src/screens/gym/GymHomeScreen.tsx`](file:///c:/Users/perso/.gemini/antigravity/scratch/zentrack-vibe2ship/mobile/src/screens/gym/GymHomeScreen.tsx) | `GymHomeScreen` | `GymHome` | Modular Gym Hub: `useGymAiPlanManager`, `GymExerciseDraggableRow` drag/reorder, `GymWorkoutBanner` timer/CTA, day switcher, and readiness deload trigger. |
| [`src/screens/gym/ActiveLoggingScreen.tsx`](file:///c:/Users/perso/.gemini/antigravity/scratch/zentrack-vibe2ship/mobile/src/screens/gym/ActiveLoggingScreen.tsx) | `ActiveLoggingScreen` | `ActiveLogging` | Modular Workout Execution: memoized `SwipeableSetRow` gesture tracking, `ActiveExerciseHeader`, `ActiveQuickChips`, `ActiveExerciseVideo` YouTube healer, `SupersetPickerModal`, `ActiveSwapModal`, and animated sticky rest timer. |
| [`src/screens/gym/WorkoutSummaryScreen.tsx`](file:///c:/Users/perso/.gemini/antigravity/scratch/zentrack-vibe2ship/mobile/src/screens/gym/WorkoutSummaryScreen.tsx) | `WorkoutSummaryScreen` | `WorkoutSummary` | Modular Workout Summary: volume stats, PR recognition with XP rewards, confetti cannon, and memoized `WorkoutSummaryProgressionChart`. |
...
| [`src/components/Gym/AddExerciseModal.tsx`](file:///c:/Users/perso/.gemini/antigravity/scratch/zentrack-vibe2ship/mobile/src/components/Gym/AddExerciseModal.tsx) | `AddExerciseModal` | Modular search-as-you-type modal: `ExerciseSearchDropdown`, `ExerciseCustomFields`, and `addExerciseStyles`. |
...
| [`src/components/Gym/GymExerciseDraggableRow.tsx`](file:///c:/Users/perso/.gemini/antigravity/scratch/zentrack-vibe2ship/mobile/src/components/Gym/GymExerciseDraggableRow.tsx) | `GymExerciseDraggableRow` | Memoized drag-and-drop exercise reordering card with superset partner lines. |
...
| [`src/components/Gym/SwipeableSetRow.tsx`](file:///c:/Users/perso/.gemini/antigravity/scratch/zentrack-vibe2ship/mobile/src/components/Gym/SwipeableSetRow.tsx) | `SwipeableSetRow` | Memoized PanResponder gesture set row with swipe-to-log mechanics. |
