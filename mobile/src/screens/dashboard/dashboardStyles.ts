...
export const makeStyles = (colors: any) => StyleSheet.create({
  ...
  headerActionPill: {
    ...
    height: 40,
    borderRadius: 20,
    backgroundColor: colors.surface2 || (colors.background === '#000000' ? '#1C1C1E' : '#F0EFF7'),
    borderWidth: 1,
  ...
  headerPillAvatar: {
    ...
    height: 28,
    borderRadius: 14,
    backgroundColor: colors.background === '#000000' ? '#2C2C2E' : '#E2E1EA',
    alignItems: 'center',
    justifyContent: 'center',
  },
  headerPillAvatarText: {
    fontSize: 12,
    fontFamily: FONT_FAMILY.bold,
  ...
  // ── Quick Profile BottomSheet (Apple iOS 18 Inset Grouped) ──
  profileHeaderCard: {
    borderRadius: 22,
    backgroundColor: colors.surface2 || (colors.background === '#000000' ? '#16161A' : '#FFFFFF'),
    borderWidth: 1,
    borderColor: colors.border,
    padding: SPACE.md,
    marginBottom: SPACE.xs,
  ...
  profileAvatarRing: {
    ...
    borderRadius: 32,
    borderWidth: 1.5,
    borderColor: colors.accentPrimary || '#818cf8',
  },
  profileInfoBox: {
    flex: 1,
    marginLeft: 14,
  ...
  profileLevelPill: {
    ...
    borderWidth: 1,
    borderColor: colors.accentPrimary ? `${colors.accentPrimary}25` : 'transparent',
  },
  profileLevelText: {
    fontFamily: FONT_FAMILY.bold,
    fontSize: 11.5,
  ...
  profileXpTrackContainer: {
    marginTop: 13,
    paddingTop: 11,
    borderTopWidth: StyleSheet.hairlineWidth,
    borderTopColor: colors.border,
  },
  profileXpTrackLabels: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    alignItems: 'center',
    marginBottom: 6,
  },
  profileXpCurrentText: {
  ...
  profileXpProgressBarBg: {
    height: 5,
    borderRadius: 3,
    backgroundColor: colors.surface || (colors.background === '#000000' ? '#252528' : '#E5E5EA'),
    overflow: 'hidden',
  },
  profileXpProgressBarFill: {
    height: '100%',
    borderRadius: 3,
  ...
  profileThemePill: {
    ...
    paddingVertical: 4.5,
    borderRadius: 13,
    backgroundColor: colors.surface || (colors.background === '#000000' ? '#222226' : '#F2F2F7'),
    borderWidth: 1,
    borderColor: colors.border,
  },
  profileThemePillText: {
    fontFamily: FONT_FAMILY.medium,
    fontWeight: '600',
    fontSize: 11.5,
    color: colors.textPrimary,
  ...
  profileStreakBadge: {
    ...
    paddingVertical: 4,
    borderRadius: 11,
    backgroundColor: colors.accentAmberDim || 'rgba(245,158,11,0.12)',
    borderWidth: 1,
  ...
  profileStreakBadgeText: {
    fontFamily: FONT_FAMILY.bold,
    fontSize: 11.5,
    color: colors.accentAmber || '#f59e0b',
  },
  profileFooterText: {
    fontFamily: FONT_FAMILY.regular,
    fontSize: 11.5,
