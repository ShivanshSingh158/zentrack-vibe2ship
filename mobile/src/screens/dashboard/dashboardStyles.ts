...
export const makeStyles = (colors: any) => StyleSheet.create({
  ...
  // Quick Profile BottomSheet (Apple iOS 18 Grouped style)
  profileHeaderCard: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingVertical: SPACE.md,
  ...
  profileGroupCard: {
    borderRadius: 18,
    backgroundColor: colors.surface2 || (colors.background === '#000000' ? '#141416' : '#FFFFFF'),
    borderWidth: 1,
    borderColor: colors.border,
    overflow: 'hidden',
  },
  ...
  profileThemePill: {
    ...
    paddingVertical: 4,
    borderRadius: 12,
    backgroundColor: colors.surface || (colors.background === '#000000' ? '#1C1C1E' : '#F0EFF7'),
    borderWidth: 1,
    borderColor: colors.border,
  },
