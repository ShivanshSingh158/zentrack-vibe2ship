...
export const makeStyles = (colors: any, isDark: boolean = true) => StyleSheet.create({
  ...
  overviewCard: {
    ...
    borderWidth: 1,
    borderColor: isDark ? '#1c1c20' : '#E2E1EA',
    borderRadius: 16,
  },
  ...
  progressBarBg: { flex: 1, height: 8, backgroundColor: isDark ? '#1c1c20' : '#E2E1EA', borderRadius: 4, overflow: 'hidden' as const },
  ...
  warningBanner: {
    ...
    marginBottom: 6,
    padding: 14,
    backgroundColor: isDark ? '#0d0d10' : 'rgba(245,158,11,0.08)',
    borderWidth: 1,
  ...
  segmentedToggleContainer: {
    flexDirection: 'row' as const,
    alignItems: 'center' as const,
    backgroundColor: isDark ? '#0d0d10' : '#F0EFF5',
    borderRadius: 18,
    padding: 2.5,
    borderWidth: 1,
    borderColor: isDark ? '#1c1c20' : 'transparent',
    gap: 2,
  },
  segmentBtn: {
  ...
  // By Subject Section Card with Apple iOS Squircle Geometry & High-Precision Alignment
  bySubjectCard: {
    backgroundColor: isDark ? '#000000' : '#FFFFFF',
    borderRadius: 20,
    borderWidth: 1,
  ...
  plainProgressBarBg: {
    flex: 1,
    height: 6,
    backgroundColor: isDark ? '#1c1c20' : 'rgba(0, 0, 0, 0.06)',
    borderRadius: 999,
  ...
  bySubjectBunkRow: {
    ...
    borderTopColor: isDark ? '#1c1c20' : 'rgba(0, 0, 0, 0.05)',
  },
  ...
  unloggedActionsRow: {
    ...
    paddingTop: 10,
    borderTopWidth: 1,
    borderColor: isDark ? '#1c1c20' : '#F0EFF5',
  },
  unloggedActionBtn: {
    flex: 1,
    flexDirection: 'row' as const,
