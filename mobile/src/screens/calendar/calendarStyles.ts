...
export const makeStyles = (colors: any, isDark: boolean = true) => StyleSheet.create({
  ...
  todayBtn: {
    ...
    borderWidth: 1,
    borderColor: isDark ? 'rgba(165,153,255,0.30)' : 'rgba(108,92,231,0.22)',
  },
  todayBtnText: {
    fontFamily: FONT_FAMILY.bold,
    fontSize: 12,
  ...
  viewMenuIconBoxActive: {
    backgroundColor: isDark ? 'rgba(165,153,255,0.22)' : 'rgba(108,92,231,0.15)',
  },
  viewMenuItemText: {
    fontFamily: FONT_FAMILY.bold,
    fontSize: 13.5,
