...
const s = StyleSheet.create({
  ...
  container: { backgroundColor: '#0c0c0e', borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: 20, height: '82%', borderTopWidth: 1, borderColor: 'rgba(255,255,255,0.08)' },
  header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 },
  headerIconBox: { width: 32, height: 32, borderRadius: 10, backgroundColor: 'rgba(165,153,255,0.12)', borderWidth: 1, borderColor: 'rgba(165,153,255,0.25)', alignItems: 'center', justifyContent: 'center' },
  headerTitle: { fontFamily: FONT_FAMILY.bold, fontSize: 17, color: '#FFFFFF' },
  closeBtn: { padding: 6, backgroundColor: '#18181b', borderRadius: 16, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)' },
  ...
  progressBarTrack: { width: 120, height: 4, backgroundColor: '#18181b', borderRadius: 2, overflow: 'hidden' },
  ...
  topicPill: { backgroundColor: 'rgba(165,153,255,0.08)', paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8, borderWidth: 1, borderColor: 'rgba(165,153,255,0.2)' },
  ...
  cardFace: { flex: 1, backgroundColor: '#141416', borderRadius: 20, padding: 24, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)', justifyContent: 'space-between' },
  cardFaceBack: { backgroundColor: '#141416', borderColor: 'rgba(0,193,110,0.25)' },
  ...
  hintBox: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: 'rgba(245,166,35,0.08)', padding: 10, borderRadius: 10, borderWidth: 1, borderColor: 'rgba(245,166,35,0.2)' },
  ...
  starCircle: { width: 72, height: 72, borderRadius: 36, backgroundColor: 'rgba(0,193,110,0.12)', alignItems: 'center', justifyContent: 'center', marginBottom: 16, borderWidth: 1, borderColor: 'rgba(0,193,110,0.25)' },
  ...
  xpBadge: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: 'rgba(0,193,110,0.12)', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 14, marginTop: 16, borderWidth: 1, borderColor: 'rgba(0,193,110,0.25)' },
  xpBadgeText: { color: '#00c16e', fontSize: 13, fontFamily: FONT_FAMILY.bold },
  doneBtn: { backgroundColor: '#FFFFFF', paddingVertical: 14, paddingHorizontal: 28, borderRadius: 14, marginTop: 24, width: '100%', alignItems: 'center' },
  doneBtnText: { color: '#000000', fontSize: 14, fontFamily: FONT_FAMILY.bold },
});
