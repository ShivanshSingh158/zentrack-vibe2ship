/**
 * NotificationsSettingsScreen G현 ZenTrack Mobile
 *
 * Full notification customization:
 *  G혀 Per-module toggles (Tasks, Habits, Gym, Attendance, Focus, Sara)
 *  G혀 10 smart notification types (habit streak, overdue tasks, assignments, etc.)
 *  G혀 Quiet hours (start + end time)
 *  G혀 Pre-task buffer time (15/30/60/120 min)
 *  G혀 Weekday vs. weekend mode
 *  G혀 Morning briefing time
 *  G혀 Inactivity nudge threshold
 *  G혀 XP milestone toggle
...
export default function NotificationPreferencesComponent() {
  ...
  // Toggle helper G현 saves + reschedules
      ...
      <ScrollView contentContainerStyle={s.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={s.card}>
          <ToggleRow
            ...
            subtitle={`No notifications ${displayTime(quietStart)} G혀 ${displayTime(quietEnd)}`}
            value={quietHours}
