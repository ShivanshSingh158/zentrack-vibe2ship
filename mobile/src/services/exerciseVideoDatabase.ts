/**
 * exerciseVideoDatabase.ts — ZenTrack Mobile
 * Curated 400+ Industry-Standard Exercise Video Dictionary (2020+, <= 90s Shorts).
 */

export const KNOWN_EXERCISE_VIDEOS: Record<string, string> = {
  // ─── CHEST (50+ VARIATIONS) ─────────────────────────────────────────────
  ...
  'tricep kickbacks': 'b5le--KkyH0',
  'tricep kickback': 'b5le--KkyH0',
  'dumbbell kickbacks': 'b5le--KkyH0',
  ...
  'leg press calf extension': 'n-5T_oYc1oU',
  ...
  'lying leg raises': 'Fl8rJJ7mZJM',
  'lying leg raise': 'Fl8rJJ7mZJM',
  'floor leg raise': 'Fl8rJJ7mZJM',
