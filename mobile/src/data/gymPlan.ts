...
export const GYM_PLAN_ARNOLD: GymPlanDay[] = [
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: 'ppl_d4_e6', name: 'Cable Cross-Body Tricep Extensions', targetSets: 3, targetReps: '10–15', muscle: 'Lat/Med Tricep', videoId: '0rAlOwNPJno' },
      { id: 'ppl_d4_e7', name: 'Cable Skull Crusher', targetSets: 3, targetReps: '10–12', muscle: 'Long Tricep', videoId: 'q-mZQep-LMI' },
    ],
  },
  {
    dayIndex: 5,
    ...
    focus: 'Heavy barbell & cable rowing, spinal erector health, and brachialis.',
    exercises: [
      { id: 'ppl_d5_e1', name: 'Barbell Rows', targetSets: 3, targetReps: '8–10', muscle: 'Mid-Back', videoId: 't9DDSK40PKY' },
