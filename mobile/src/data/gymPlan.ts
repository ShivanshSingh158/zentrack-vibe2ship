...
export const GYM_PLAN_PPL: GymPlanDay[] = [
  {
    ...
    exercises: [
      ...
      { id: 'ppl_d1_e4', name: 'Machine Overhead Press', targetSets: 4, targetReps: '8–12', muscle: 'Front Delts', videoId: 'TFayqrepbXE' },
      { id: 'ppl_d1_e5', name: 'Cable Lateral Raises', targetSets: 3, targetReps: '12–15', muscle: 'Side Delts', videoId: 'xrBcuPNTxLg' },
      { id: 'ppl_d1_e6', name: 'Egyptian Lateral Raise', targetSets: 3, targetReps: '12–15', muscle: 'Side Delts', videoId: 'Ghm3u9nMDBg' },
      { id: 'ppl_d1_e7', name: 'Dual-Rope Tricep Pushdowns', targetSets: 3, targetReps: '10–15', muscle: 'Lat/Med Tricep', videoId: 'i5I7RGyWwo8' },
  ...
  },
  {
    ...
    exercises: [
      ...
      { id: 'ppl_d2_e4', name: 'Machine Cable Wide-Grip Rows', targetSets: 3, targetReps: '10–12', muscle: 'Mid-Back', videoId: 'MJkkx26RWPk' },
      { id: 'ppl_d2_e5', name: 'Cable Shrugs', targetSets: 3, targetReps: '12–15', muscle: 'Upper Traps', videoId: '-FBZ2evfXVs' },
      { id: 'ppl_d2_e6', name: 'Reverse Pec Deck Fly', targetSets: 3, targetReps: '12–15', muscle: 'Rear Delts', videoId: 'O2J8Qs7Wl3U' },
      { id: 'ppl_d2_e7', name: 'Preacher Curls', targetSets: 3, targetReps: '10–12', muscle: 'Short Bicep', videoId: 'Cn_S3OKOWBc' },
      { id: 'ppl_d2_e8', name: 'Face-Away Cable Curls', targetSets: 3, targetReps: '10–12', muscle: 'Long Bicep', videoId: 'zHz6Be6Eyag' },
      { id: 'ppl_d2_e9', name: 'Dumbbell Hammer Curls', targetSets: 3, targetReps: '10–12', muscle: 'Brachialis', videoId: 'lmIo_gVE8T4' },
    ],
  },
  {
    dayIndex: 3,
    ...
    exercises: [
      ...
      { id: 'ppl_d3_e6', name: 'Reverse Crunches', targetSets: 2, targetReps: '12–15', muscle: 'Lower Abs', videoId: '8E4nGnNKLgI' },
      { id: 'ppl_d3_e7', name: 'Planks', targetSets: 2, targetReps: '60s', muscle: 'Transverse Abs', videoId: 'v25dawSzRTM' },
      { id: 'ppl_d3_e8', name: 'Cable Woodchoppers', targetSets: 2, targetReps: '10–15', muscle: 'Obliques', videoId: 'YIU0U_B57rU' },
      { id: 'ppl_d3_e9', name: 'Machine Wrist Curls', targetSets: 3, targetReps: '15–20', muscle: 'Forearm Flexors', videoId: '3VLTzIrnb5g' },
      { id: 'ppl_d3_e10', name: 'Machine Reverse Wrist Curls', targetSets: 2, targetReps: '15–20', muscle: 'Forearm Extensors', videoId: 'B699nq91i_w' },
    ],
  },
  {
    dayIndex: 4,
    ...
    exercises: [
      ...
      { id: 'ppl_d4_e3', name: 'Cable Crossovers (mid pulley)', targetSets: 3, targetReps: '10–15', muscle: 'Mid Chest', videoId: 'I-Ue34qLxc4' },
      { id: 'ppl_d4_e4', name: 'Cable Lateral Raises', targetSets: 3, targetReps: '12–15', muscle: 'Side Delts', videoId: 'xrBcuPNTxLg' },
      { id: 'ppl_d4_e5', name: 'Dumbbell Lateral Raises', targetSets: 3, targetReps: '12–15', muscle: 'Side Delts', videoId: 'JMt_uxE8bBc' },
      { id: 'ppl_d4_e6', name: 'Reverse-Grip Pushdown', targetSets: 2, targetReps: '10–15', muscle: 'Lat/Med Tricep', videoId: '_EuYEt1lNYw' },
      { id: 'ppl_d4_e7', name: 'Cable Cross-Body Tricep Extensions', targetSets: 3, targetReps: '10–15', muscle: 'Lat/Med Tricep', videoId: '0rAlOwNPJno' },
      { id: 'ppl_d4_e8', name: 'Cable Skull Crusher', targetSets: 3, targetReps: '10–12', muscle: 'Long Tricep', videoId: 'q-mZQep-LMI' },
      { id: 'ppl_d4_e9', name: 'Single-Arm Overhead Cable Extension', targetSets: 3, targetReps: '10–12', muscle: 'Long Tricep', videoId: 'FE_AsjcTImc' },
    ],
  },
  {
    dayIndex: 5,
    ...
    exercises: [
      { id: 'ppl_d5_e1', name: 'Machine Lat Pulldown', targetSets: 3, targetReps: '10–12', muscle: 'Lat Width', videoId: 'bNmvKpJSWKM' },
      { id: 'ppl_d5_e2', name: 'Seated Cable Rows V-Bar', targetSets: 3, targetReps: '10–12', muscle: 'Mid-Back', videoId: 'HoWHac5nbLo' },
      { id: 'ppl_d5_e3', name: 'Barbell Rows', targetSets: 3, targetReps: '8–10', muscle: 'Mid-Back', videoId: 't9DDSK40PKY' },
      ...
      { id: 'ppl_d5_e6', name: 'Face Pulls', targetSets: 2, targetReps: '12–15', muscle: 'Rear Delts', videoId: 'qEyoBOpvqR4' },
      { id: 'ppl_d5_e7', name: 'Alternating Dumbbell Curls', targetSets: 3, targetReps: '10–12', muscle: 'Short Bicep', videoId: 'BYfbajT1KCA' },
      { id: 'ppl_d5_e8', name: 'Incline Dumbbell Curls', targetSets: 3, targetReps: '10–12', muscle: 'Long Bicep', videoId: '0-qmVm4tHDw' },
      { id: 'ppl_d5_e9', name: 'Reverse Cable Curls', targetSets: 3, targetReps: '10–12', muscle: 'Brachioradialis', videoId: 'z4D7dwPjsO8' },
    ],
  },
  {
    dayIndex: 6,
    ...
    exercises: [
      { id: 'ppl_d6_e1', name: 'Leg Extensions', targetSets: 3, targetReps: '12–15', muscle: 'Quads', videoId: '2zZ3vkPsExQ' },
      { id: 'ppl_d6_e2', name: 'Heel-Elevated Goblet Squats', targetSets: 3, targetReps: '10–12', muscle: 'Quad Teardrop', videoId: '0wz99W3lbAs' },
      { id: 'ppl_d6_e3', name: 'Romanian Deadlifts (RDLs)', targetSets: 3, targetReps: '8–10', muscle: 'Hamstrings', videoId: 'cjRSNsvqpd8' },
      { id: 'ppl_d6_e4', name: 'Standing Machine Calf Raises', targetSets: 3, targetReps: '12–15', muscle: 'Gastrocnemius', videoId: 'n-5T_oYc1oU' },
      { id: 'ppl_d6_e5', name: 'Kneeling Cable Crunches', targetSets: 3, targetReps: '10–15', muscle: 'Upper Abs', videoId: 'CDO29I7PCoc' },
      { id: 'ppl_d6_e6', name: 'Hanging Knee Raises', targetSets: 3, targetReps: '12–15', muscle: 'Lower Abs', videoId: 'Fl8rJJ7mZJM' },
      { id: 'ppl_d6_e7', name: 'Pallof Press', targetSets: 2, targetReps: '10–12', muscle: 'Transverse Abs', videoId: '5aZ0IhJS8O8' },
      { id: 'ppl_d6_e8', name: 'Heel Touches', targetSets: 2, targetReps: '12–15', muscle: 'Obliques', videoId: '3MNj7LrRX3U' },
      { id: 'ppl_d6_e9', name: 'Behind-the-Back Barbell Wrist Curls', targetSets: 3, targetReps: '15–20', muscle: 'Forearm Flexors', videoId: 'Cj9RNAYD7iY' },
      { id: 'ppl_d6_e10', name: 'Machine Reverse Wrist Curls', targetSets: 2, targetReps: '15–20', muscle: 'Forearm Extensors', videoId: 'B699nq91i_w' },
    ],
  },
  {
    dayIndex: 7,
